...
\begin{figure}[ht]
	...
	\subfloat[$0.05\%$ \ch{Nb} doped \ch{WSe2} channel transmission lines with corresponding channel lengths and widths of $L_{12} = 1.04\unita{\mu m}$ $W_{12} = 4.42\unita{\mu m}$, $L_{23} = 2.04\unita{\mu m}$, $W_{23} = 4.47\unita{\mu m}$, $L_{34} = 3.09\unita{\mu m}$, $W_{34} = 4.90\unita{\mu m}$, $W_{45} = 5.15\unita{\mu m}$, and $L_{45} = 4.27\unita{\mu m}$. ]{
		\includegraphics[height=4cm,width=6cm]{figs/results/transmission_line/transmission_device_pic_5-5_21_10232015_no1}
		\label{fig:transmission_device_10232015_no1}
	}
	\qquad
	\subfloat[Caption here]{
		\includegraphics[height=5cm,width=7cm]{figs/results/transmission_line/transmission_resistance_plot_pic_5-5_21_10232015_no1}
	...
	\subfloat[$0.05\%$ \ch{Nb} doped \ch{WSe2} channel transmission lines with corresponding channel lengths and widths of $L_{12} = 0.42\unita{\mu m}$, $W_{12} = 2.27\unita{\mu m}$, $L_{23} = 0.83\unita{\mu m}$, $W_{23} = 2.30\unita{\mu m}$, $L_{34} = 2.01\unita{\mu m}$, $W_{34} = 2.27\unita{\mu m}$, $W_{45} = 2.45\unita{\mu m}$, and $L_{45} = 3.02\unita{\mu m}$.]{
		\includegraphics[height=4cm,width=6cm]{figs/results/transmission_line/transmission_device_pic_56_21_10232015_no2}
		\label{fig:transmission_device_10232015_no2}
	}
	\qquad
	\subfloat[Caption here]{
		\includegraphics[height=5cm,width=7cm]{figs/results/transmission_line/transmission_resistance_plot_pic_56_21_10232015_no2}
	...
	\subfloat[$0.05\%$ \ch{Nb} doped \ch{WSe2} channel transmission lines with corresponding channel lengths and widths of $L_{12} = 0.43\unita{\mu m}$, $W_{12} = 2.10\unita{\mu m}$, $L_{23} = 0.93\unita{\mu m}$, $W_{23} = 1.90\unita{\mu m}$, $L_{34} = 1.34\unita{\mu m}$, $W_{34} = 1.98\unita{\mu m}$, $L_{56} = 2.00\unita{\mu m}$, $W_{56} = 1.89\unita{\mu m}$, $W_{67} = 1.80\unita{\mu m}$, and $L_{67} = 2.58\unita{\mu m}$.]{
		\includegraphics[height=4cm,width=6cm]{figs/results/transmission_line/transmission_device_pic_-66_21_11182015_no2}
		\label{fig:transmission_device_11182015_no2}
	}
	\qquad
	\subfloat[Caption here]{
		\includegraphics[height=5cm,width=7cm]{figs/results/transmission_line/transmission_resistance_plot_pic_-66_21_11182015_no2}
...
\begin{figure}[ht]
	...
	\subfloat[Hall bar device with a 0.05\% \ch{Nb} doped \ch{WSe2} channel. Device thickness is $18.6\unita{nm}$ with an average width of $W_\mathrm{avg} = 14\unita{\mu m}$.]{
		\includegraphics[height=4cm,width=6cm]{figs/results/hall_bar_doped_channel/hall_bar_device_pic_5-5_21_10152015_no2_doping_scheme}
	...
	\subfloat[Hall bar device with a 0.05\% \ch{Nb} doped \ch{WSe2} channel. Device thickness is $7.74\unita{nm}$ with an average width of $W_\mathrm{avg} = 5.74\unita{\mu m}$.]{
		\includegraphics[height=4cm,width=6cm]{figs/results/hall_bar_doped_channel/hall_bar_device_pic_11192015_no2_doping_scheme}
		\label{fig:hall_bar_11182015_no2_modified}
	}
	\caption[0.05\% \ch{Nb} channel doped \ch{WSe2} Hall bar devices]{Lightly doped channel \ch{WSe2} Hall bar devices.}
...
\begin{figure}[ht]
	\centering
	\subfloat[Caption 1]{
		\includegraphics[height=5cm,width=7cm]{figs/results/hall_bar_doped_channel/hall_bar_device_pic_5-5_21_10152015_no2_conduct_vs_Vbg_all_temps}
		\label{fig:hall_bar_10152015_no2_conduct_vs_Vbg_all_temps}
	}
	\qquad
	\subfloat[Caption 2]{
		\includegraphics[height=5cm,width=7cm]{figs/results/hall_bar_doped_channel/hall_bar_device_pic_5-5_21_10152015_no2_mu_hall_vs_Vbg_all_temps_linear}
...
\begin{figure}[ht]
	\centering
	\subfloat[Caption 2]{
		\includegraphics[height=5cm,width=7cm]{figs/results/hall_bar_doped_channel/hall_bar_device_pic_11192015_no1_conduct_vs_Vbg_all_temps}
		\label{fig:hall_bar_11192015_no1_conduct_vs_Vbg_all_temps}
	}
	\qquad
	\subfloat[Caption 1]{
		\includegraphics[height=5cm,width=7cm]{figs/results/hall_bar_doped_channel/hall_bar_device_pic_11192015_no1_mu_hall_vs_Vbg_all_temps}
...
\begin{figure}[ht]
	...
	\subfloat[$I-V$ characteristics, $T=300\unita{K}$ add more here $\ldots$.]{
		\includegraphics[height=3.25cm,width=5cm]{figs/results/hall_bar_doped_channel/Vds-Id_1V_-1V-Vbg_20V_-70V_T1-D_T5_S_300K_plot_modified_11192015_no2}
		\label{fig:iv_curve_hall_bar}
	}
	%\qquad
	\subfloat[caption]{
		\includegraphics[height=3.25cm,width=5cm]{figs/results/hall_bar_doped_channel/Charge_density_Vs_Vbg_different_Temp_plot_modified_11192015_no1}
		\label{fig:charge_density_vs_Vbg_all_temp}
	}
	%\qquad
	\subfloat[caption]{
		\includegraphics[height=3.25cm,width=5cm]{figs/results/hall_bar_doped_channel/HallMobility_Vs_T_for_fixed_carrier_consentrations_plot_modified_11192015_no2}
...
\begin{figure}[ht]
	\centering
	\subfloat[$0.01\%$ \ch{Nb} doped \ch{WSe2} transferred to \hbn substrate.]{
		\includegraphics[height=4cm,width=3cm]{figs/results/hall_bar_doped_channel_doped_contacts/pWSe2_on_hBN_substrate_5-5_21_no1}
		\label{fig:pWSe2_doped_contacts_and_channel_step1}
	}
	\qquad
	\subfloat[Top \hbn transferred on \ch{WSe2} channel.]{
		\includegraphics[height=4cm,width=3cm]{figs/results/hall_bar_doped_channel_doped_contacts/pWSe2_on_hBN_substrate_with_top_hBN_5-5_21_no1}
		\label{fig:fig:pWSe2_doped_contacts_and_channel_step2}
	}
	\qquad
	\subfloat[Degenerately doped ($0.5\%$ \ch{Nb} doped \ch{WSe2}) contacts transferred.]{
		\includegraphics[height=4cm,width=3cm]{figs/results/hall_bar_doped_channel_doped_contacts/pWSe2_on_hBN_substrate_with_top_hBN_doped_contact_transfer_5-5_21_no1}
		\label{fig:fig:pWSe2_doped_contacts_and_channel_step3}
	}
	\qquad
	\subfloat[Device with $0.01\%$ \ch{Nb} doped \ch{WSe2} channel and $0.5\%$ \ch{Nb} doped \ch{WSe2} contacts with electrodes fabricated. Channel dimensions: $L = 12.9\unita{\mu m}$ and $W = 7.5\unita{\mu m}$ with a device thickness of $5.6\unita{nm}$.]{
		\includegraphics[height=4cm,width=3cm]{figs/results/hall_bar_doped_channel_doped_contacts/pWSe2_device_with_electrodes_5-5_21_no1}
		\label{fig:fig:pWSe2_doped_contacts_and_channel_final_device}
	}
	\caption[\ch{WSe2} device with degenerately doped contacts and lightly doped channel]{Caption}
	\label{fig:doped_contacts_fabrication_steps}
\end{figure}
...
\begin{figure}[ht]
	...
	\subfloat[Top \hbn transferred on \ch{WSe2} channel.]{
		...
		\label{fig:fig:pWSe2_doped_contacts_and_channel_step2_pt2}
	}
	...
	\subfloat[Degenerately doped ($0.5\%$ \ch{Nb} doped \ch{WSe2}) contacts transferred.]{
		...
		\label{fig:fig:pWSe2_doped_contacts_and_channel_step3_pt2}
	}
	\qquad
	\subfloat[Device with $0.01\%$ \ch{Nb} doped \ch{WSe2} channel and $0.5\%$ \ch{Nb} doped \ch{WSe2} contacts with electrodes fabricated. Channel dimensions: $L = 9.0\unita{\mu m}$ and $W = 4.02\unita{\mu m}$ with a device thickness of $9\unita{nm}$.]{
		...
		\label{fig:fig:pWSe2_doped_contacts_and_channel_final_device_pt2}
	}
	\caption[\ch{WSe2} device with degenerately doped contacts and lightly doped channel]{Caption}
...
\begin{figure}[ht]
	\centering
	\subfloat[caption]{
		\includegraphics[height=4cm,width=6cm]{figs/results/hall_bar_doped_channel_doped_contacts/Two_Probe_FE_Mobility_Vs_T_Vds_-1V_-50mV_plot_pre_anneal_5-5_21_no1}
		%\label{fig:}
	}
	\qquad
	\subfloat[caption]{
		\includegraphics[height=4cm,width=6cm]{figs/results/hall_bar_doped_channel_doped_contacts/Two_Probe_FE_Mobility_Vs_T_Vds_-1V_-50mV_plot_post_anneal_5-5_21_no1}
		%\label{fig:}
	}
...
\begin{figure}[ht]
	\centering
	\subfloat[caption]{
		\includegraphics[height=4cm,width=6cm]{figs/results/hall_bar_doped_channel_doped_contacts/Conductivity_Vs_Vbg_different_T_vds_-1V_plot_-6-5_21_no1}
		%\label{fig:}
	}
	\qquad
	\subfloat[caption]{
		\includegraphics[height=4cm,width=6cm]{figs/results/hall_bar_doped_channel_doped_contacts/Two_Probe_FE_Mobility_Vs_T_Comparison_plot_Vds_-1V_-50mV_-6-5_21_no1}
		%\label{fig:}
	}
	\caption[Caption]{Caption}
	%\label{fig:}
