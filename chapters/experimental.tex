...
%\begin{figure}[ht]
%	\centering
%	\includegraphics[height=5cm,width=5cm]{figs/experimental/SEM}
%	\caption[SEM]{SEM}
...
\begin{figure}[ht]
	...
	\qquad
	\begin{minipage}[b]{0.45\linewidth}
		\includegraphics[height=4cm,width=4cm]{figs/experimental/o2_plasma_control_panel}
