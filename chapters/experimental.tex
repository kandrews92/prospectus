...
\begin{figure}[ht]
	...
	\qquad
	\subfloat[Physical property measurement system]{
		\includegraphics[height=6cm,width=4cm]{figs/experimental/ppms}
		\label{fig:ppms}
	}
	\caption[Electrical measurement devices]{Electrical measurement devices used for electrical characterization of samples including vacuum and low temperature environments.}
